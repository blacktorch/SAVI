...
public class UgVBehavior extends UxVBehavior {
	 ...
	 */
	public UgVBehavior(String id, String type, PVector initialPosition, double reasoningCyclePeriod, double sensorsErrorProb, double sensorsErrorStdDev, double RANDOM_SEED) {	
		// Initialize data values
		super(id, type, initialPosition,reasoningCyclePeriod, sensorsErrorProb, sensorsErrorStdDev, RANDOM_SEED);
	}
